<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="panel.aspx.cs" Inherits="helloWorld.Admin.Question.panel" %>
                                        ...
                                        <tr>
                                                    <td>
                                                      <table align ="center" class="style18">
                                                          <tr>
                                                              <td class="style9">
                                                                  <asp:Button ID="back" runat="server" Height="20px" Text="Back" Width="100px" OnClick="back_Click" />
                                                              </td>
                                                              <td class="style10">
