<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/ADMIN.Master" AutoEventWireup="true" CodeBehind="AssignCourse.aspx.cs" Inherits="helloWorld.Admin.AssignCourse" %>
            ...
            <table  align="center">
                ...
                <tr>
                   ...
                   <td class="style1">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:testConnectionString %>" SelectCommand="SELECT [CourseName] FROM [AddCourse]"></asp:SqlDataSource>
                ...
                <tr>
                    <td class="lbl">Course ID</td>
                    <td class="style1">
                        <asp:DropDownList ID="DropDownListCourseId" DataSourceID="SqlDataSource6" CssClass="txt" runat="server" DataTextField="CourseID" DataValueField="CourseID" AutoPostBack="True"></asp:DropDownList>
